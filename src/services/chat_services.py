...
class ChatLLMService:
    def __init__(self, predictor_pipeline, chat_history_pipeline,store):
        # singleton store
        self.store = store
    ...
    def process_chat(self, query: str, sentiment:str, context = None) -> str:
        # 1. Ambil history
        ...
        self.writer.run(messages=[user_msg])
        context = history + "\nUser: " + query
        ...
        self.writer.run(messages=[assistant_msg])
